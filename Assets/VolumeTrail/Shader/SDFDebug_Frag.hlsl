...
float4 SDFDebug_Frag(PackedVaryingsToPS packedInput) : SV_Target
{
    ...
    float3 worldSpacePos = input.positionRWS+_WorldSpaceCameraPos;

    float d = GetSignedDistance(worldSpacePos);
